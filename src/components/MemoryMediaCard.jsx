...
const MemoryMediaCard = ({ memory }) => {
  useEffect(() => {
    // This would be where you initialize your diamond particle animation
    // Using a library like particles.js or similar
  }, []);
      ...
      <div className={styles.bottom}>
        ...
        <div className={styles.actions}>
          ...
          <button className={styles.actionButton}>
            ...
            >
              <path
                d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18c0-2-3-2-3-9"
                stroke="#D4AF37"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
